...
<td>We have not made any commits to the repository so far.</td>
</tr>
<tr>
<td>Untracked files</td>
<td>Git found some files which are listed below this message. This implies that Git was able to find some files which are part of the folder which Git is Tracking for changes.</td>
</tr>
</tbody>
